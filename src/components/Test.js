...
// Importing Person
export const Test = ({ page, setPage }) => {
  // const gltf = useGLTF('/pikachu/source/pikachu2.glb', true)
  // const { ref: personRef, actions } = useAnimations(gltf.animations)
  // console.log("a", useAnimations(gltf.animations))
  ...
  //     const audioChannelSrc = `./audios/pikachu/${Math.round(Math.random() * 8) + 1
  //       }.mp3`
